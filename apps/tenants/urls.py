...
urlpatterns = [
    ...
    path("equipe/affecter-boutique/", views.staff_attach_boutique, name="staff_attach_boutique"),
    path("equipe/<uuid:membership_id>/modifier/", views.staff_update, name="staff_update"),
    path("boutiques/nouvelle/", views.boutique_create, name="boutique_create"),
